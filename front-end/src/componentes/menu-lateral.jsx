  ...
  const opçõesGeradorConteúdo = [
    { label: "Página Inicial", command: () => navegar("/pagina-inicial") },
    {
      ...
      items: [
        ...
        {
          label: "Cadastrar Gerador Conteúdo",
          command: () => navegar("/cadastrar-gerador-conteudo"),
        },
        {
          label: "Administrar Canais",
          command: () => navegar("/administrar-canais-youtube"),
        },
        { label: "Sair do Sistema", command: () => sairSistema() },
      ],
    },
  ];
  const opçõesMembroCanal = [
    { label: "Página Inicial", command: () => navegar("/pagina-inicial") },
    {
      label: "Menu",
      items: [
        ...
        {
          label: "Cadastrar Membro Canal",
          command: () => navegar("/cadastrar-membro-canal"),
        },
        {
          label: "Administrar Compromissos",
          command: () => navegar("/administrar-compromissos"),
        },
        { label: "Sair do Sistema", command: () => sairSistema() },
      ],
    },
  ...
  function opçõesMenu() {
    switch (usuárioLogado.perfil) {
      case "gerador_conteúdo":
        return opçõesGeradorConteúdo;
      case "membro_canal":
        return opçõesMembroCanal;
      default:
        return;
    }
  }
